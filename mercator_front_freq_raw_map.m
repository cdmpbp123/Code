% front occurence frequency in raw grid for mercator reanalysis data
% read yearly concatenated daily data from 20180101-20181231
close all
clear all
clc
%
...
high_thresh_daily = [];
for yy = yy1:yy2
    daily_result_fn = [result_path, '/mercator_tgrad_daily_',smooth_type, '_year',num2str(yy),'.nc'];
