...
if strcmp(platform, 'hanyh_laptop')
    ...
    data_path = 'D:\lomf\frontal_detect\Data\ostia\2020\';
...
fn = [data_path,'20200316120000-UKMO-L4_GHRSST-SSTfnd-OSTIA-GLOB-v02.0-fv02.0.nc'];
...
if fig_tgrad
    ...
    colorbar
    colormap(jet);
    title('SST front of OSTIA 20200316')
