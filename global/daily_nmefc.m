...
if strcmp(platform, 'hanyh_laptop')
    ...
    data_path = 'T:\DATA\Model\NMEFC_global\';
...
fn = [data_path,'NMEFF_std_products_20200316_20200322.nc'];

[temp, grd] = nemo_preprocess(fn, lon_w, lon_e, lat_s, lat_n);
...
if fig_tgrad
    ...
    m_grid('box', 'fancy', 'tickdir', 'in', 'linest', 'none', 'ytick', -60:30:60, 'xtick', lon_w:60:lon_e);
    caxis([0 0.1])
    colorbar
    colormap(jet);
    title('SST front of NMEFC global 20200316')
