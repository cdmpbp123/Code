...
% TBD: add mercator for intercomparison, all data need to interpolated to OBS grid 
close all
clear all
clc
%
roms_exp_name = 'scs50_hindcast'; % scs50_hindcast_nudg_new
platform = 'server197';
...
% save('sst_rmse_no_nudging.mat','tempObs_mean','tempMod_mean','rmse_mean','total_days_monthly')
...
ncwriteatt(result_fn,'/','roms_data_source',roms_exp_name)
